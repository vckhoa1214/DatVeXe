                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover col-12">
                                        ...
                                        @foreach ($taiKhoans as $taiKhoan)
                                            <tr>
                                                <td class="hihi">{{ $taiKhoan->id }}</td>
                                                <td class="hihi">{{ $taiKhoan->fullName }}</td>
                                                <td class="hihi">{{ $taiKhoan->email }}</td>
                                                <td class="hihi">{{ $taiKhoan->phoneNum ?? 'Unknown'}}</td>
                                                <td class="hihi">{{ $taiKhoan->isAdmin ? 'Admin' : 'User' }}</td>
                                                <td class="d-flex pt-3 px-0">
                                                    <div class="d-flex align-items-center">
                                                        <!-- Nút sửa -->
                                                        <button
                                                            class="bi bi-pencil-square text-primary border-0 bg-transparent"
                                                            onclick="window.location.href='{{ route('dashboard.suataikhoan', ['id' => $taiKhoan->id]) }}'">
                                                        </button>

                                                        <!-- Form xóa -->
                                                        <form action="{{ route('dashboard.xoataikhoan') }}" method="POST"
...
<script>
    function navigateTo(id) {
        window.location.href = `/dashboard/quanlytaikhoan/chitiet/${id}`;
    }
