<head>
    ...
    <link rel="stylesheet" href="/css/themchuyenxe.css">
</head>
                    ...
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="updateChuyenXe" action="{{ route('dashboard.themchuyenxe.submit') }}"
                                      method="POST" enctype="multipart/form-data"
                                      class="form-sample d-flex justify-content-center flex-column">
                                    @csrf
                                    <p class="card-description" style="font-weight: bold;">
                                        <i class="fa-solid fa-road"></i> Tuyến đường
                                    </p>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row justify-content-center">
                                                <div class="col-sm-9">
                                                    <label class=""><i class="fa-solid fa-signs-post"></i> Tỉnh bắt đầu</label>
                                                    <select class="form-control" name="startProvince" required>
                                                        <option value="" hidden>Chọn tỉnh bắt đầu</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row justify-content-center">
                                                <div class="col-sm-9">
                                                    <label class=""><i class="fa-solid fa-map-location-dot"></i> Điểm
                                                        đón</label>
                                                    <input type="text" class="form-control" name="startLocation"
                                                           placeholder="Nhập điểm đón" required/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row justify-content-center">
                                                <div class="col-sm-9">
                                                    <label class=""><i class="fa-solid fa-signs-post"></i> Tỉnh kết thúc</label>
                                                    <select class="form-control" name="endProvince" required>
                                                        <option value="" hidden>Chọn tỉnh kết thúc</option>
                                                        @foreach($provinceList as $province)
                                                            <option
                                                                value="{{ $province['name'] }}">{{ $province['name'] }}</option>
                                                        @endforeach
                                            ...
                                            <div class="form-group row justify-content-center">
                                                <div class="col-sm-9">
                                                    ...
                                                    <input type="text" class="form-control" name="endLocation"
                                                           placeholder="Nhập điểm trả khách" required/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row justify-content-center">
                                                <div class="col-sm-9">
                                                    <label class=""><i class="fa-solid fa-calendar-check"></i> Ngày bắt
                                                        đầu</label>
                                                    <input type="date" class="form-control" name="startDate"
                                                           id="startDate" min="2018-01-01" max="2025-12-31" required/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row justify-content-center">
                                                <div class="col-sm-9">
                                                    <label class=""><i class="fa-solid fa-hourglass-start"></i> Thời
                                                        gian bắt đầu</label>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-6">
                                            <div class="form-group row justify-content-center">
                                                <div class="col-sm-9">
                                                    <label class=""><i class="fa-sharp fa-solid fa-calendar-xmark"></i>
                                                        Ngày kết thúc</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row justify-content-center">
                                                <div class="col-sm-9">
                                                    <label class=""><i class="fa-solid fa-hourglass-end"></i> Thời gian
                                                        kết thúc</label>
                                            ...
                                            <div class="form-group row justify-content-center">
                                                <div class="col-sm-10">
                                                    <label class="col-form-label"><i
                                                            class="fa-solid fa-van-shuttle"></i> Loại xe</label>
                                                    <select class="form-control" name="loaixe" required>
                                                        <option value="" hidden>Chọn loại xe</option>
                                                        @foreach($danhsachLoaiXe as $loaixe)
                                                            <option
                                                                value="{{ $loaixe->id }}">{{ $loaixe->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-6">
                                            <div class="form-group row justify-content-center">
                                                <div class="col-sm-10">
                                                    <label class="col-form-label"><i class="fas fa-chair"></i> Số ghế
                                                        ngồi</label>
                                                    <input type="text" class="form-control" name="totalNumSeats"
                                                           required/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row justify-content-center">
                                                <div class="col-sm-10">
                                                    <label class="col-form-label"><i
                                                            class="fa-solid fa-dollar-sign"></i> Giá vé</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row justify-content-center">
                                                <div class="col-sm-10 d-flex flex-column">
                                                    <label class="col-form-label"><i class="fa-regular fa-image"></i>
                                                        Ảnh địa điểm</label>
                                                    <img
                                    ...
                                    <div class="d-flex justify-content-center" style="padding: 10px; margin: 10px">
                                        <button type="submit" class="btn-success btn" style="margin: 10px;">Xác nhận
                                        </button>
                                        <a href="{{ route('dashboard.quanlychuyenxe') }}" class="btn-danger btn"
                                           style="margin: 10px;">Trở về</a>
                                    </div>
                                </form>
                            </div>
                        </div>
