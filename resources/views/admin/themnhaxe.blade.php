<head>
    ...
    <link rel="stylesheet" href="/css/addnhaxe.css">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="col-md-12 rightBody p-5">
                                    <form id="addNhaXe" action="{{ route('dashboard.themnhaxe.submit') }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="file" id="avatar" name="image" hidden required>
                                                    <img
                                                        src="https://ehs.stanford.edu/wp-content/uploads/missing-image.png"
                                                        alt="" class="img-avt">
                                                    <label for="avatar" class="form-label upload">Tải ảnh lên</label>
                                                </div>
                                                <div class="col-md-8">
                                                    <label class="form-label">Hình ảnh chi tiết chuyến xe</label>
                                                    <input type="file" id="anhchitiet" name="imageJours[]" multiple
                                                           required>
                                                    <img
                                                        src="https://ehs.stanford.edu/wp-content/uploads/missing-image.png"
                                                        alt="" class="img-detail">
                                                    <div class="image-detail"></div>
                                                    <label for="anhchitiet" class="form-label upload-detail">Tải ảnh
                                                        lên</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group" id="phongve">
                                            <div class="row mb-2" id="themphongve">
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-3">
                                                    <label for="mainRoute" class="form-label">Tỉnh:</label>
                                                    <select class="form-select" id="mainRoute" name="mainRoute[]"
                                                            required>
                                        ...
                                        <button type="button" class="btn btn-primary mb-3 ml-3 px-4"
                                                onclick="themphongve()"> +
                                        </button>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="5" name="policy" required></textarea>
                                        </div>

                                        {{-- Nút lưu --}}
                                        <div class="d-flex justify-content-center">
                                            <button type="submit" class="btn btn-primary mr-2">Lưu</button>
                                            <a class="btn btn-light" href="{{ route('dashboard.quanlynhaxe') }}">Trở
                                                lại</a>
                                        </div>
                                    </form>

                                    {{-- Script thêm phòng vé động nếu cần --}}
                                    <script>
                                        function themphongve() {
                                            let html = `
                                    <div class="row mb-2">
                                        <div class="col-md-3">
                                            <input type="text" class="form-control" name="phoneNo[]" placeholder="Số điện thoại" required>
                                        </div>
                                        <div class="col-md-4">
...
@endforeach
                                            ...
                                            document.getElementById('phongve').insertAdjacentHTML('beforeend', html);
                                        }
                                    </script>
                                </div>
                            </div>
...
<script>
    ...
    function themphongve() {
        let themphongve = document.getElementById("phongve");

        let s = `
        <div class="row mb-2" id="themphongve${i}">
            <div class="col-md-3">
                <div class="col-sm-10">
                    <label for="phoneNo">Số điện thoại</label>
                    <input type="text" class="form-control" name="phoneNo[]" placeholder="Số điện thoại" required>
...
<div class="col-md-2">
    <div class="col-sm-10">
        <button type="button" class="btn btn-danger mt-4 ml-3 px-4" onclick="xoaphongve(${i})"> - </button>
                </div>
            </div>
        </div>
        `;
        themphongve.insertAdjacentHTML("beforeend", s);
        i++;
    }

    function xoaphongve(a) {
        let xoaphongve = document.getElementById("phongve");
        let xoa = document.getElementById(`themphongve${a}`);
        if (xoa) {
            xoaphongve.removeChild(xoa);
        }
    }
    ...
    function sendDataToServer() {
        if (confirm("Bạn có muốn thêm nhà xe này không?")) {
            let form = document.getElementById('addNhaXe');
            form.submit();
        }
    }

    let avatar = document.querySelector("#avatar");
    let img = document.querySelector(".img-avt");
    ...
    let img_detail = document.querySelector(".img-detail");
    let input_detail = document.querySelector("#anhchitiet");
    let image_detail = document.querySelector(".image-detail");

    input_detail.addEventListener("change", function () {
